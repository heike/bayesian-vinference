...
pics <- read.csv("data/picture-details.csv", stringsAsFactors = FALSE)
...
\begin{figure}
\centering
<<pics, dependson='posterior', echo=FALSE,  fig.width=8, fig.height = 8, out.width='.7\\textwidth'>>=
...
\hh{XXX stats question: next step to work out: get a Bayes factor of picking the data plot posteriori compared to a-priori. }
